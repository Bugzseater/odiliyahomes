...
export default function Icon() {
  ...
  useEffect(() => {
    document.title =
      "ICON by Odiliya Homes | Investment Plan | Real Estate Investment Opportunities";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Invest in Sri Lanka with Odiliya Homes. Unlock profitable real estate investment opportunities and a strategic investment plan to grow your wealth today.",
      );
    }
    ...
    metaKeywords.content =
      "investment plan,real estate investment oppotunities";
  }, []);
        ...
        const fallbackProjects = [
          {
            ...
            name: "ICON V TALPE",
            description:
              "Nestled along the southern coast, Icon V Talpe is a signature beachfront residence where luxury meets oceanfront serenity.",
            image: villa1,
            category: "All Projects",
          },
          {
            ...
            name: "ICON MIRISSA",
            description:
              "Exclusive villa for sale Sri Lanka at ICON Mirissa. Luxury coastal living with full management and strong rental returns.",
            image: img1,
            category: "All Projects",
          },
          {
            ...
            name: "ICON GALLE",
            description:
              "Luxury villa for sale in Galle at ICON Galle. Riverfront wellness living from Rs. 29M with flexible payment plans and strong investment returns.",
            image: galleimg,
            category: "All Projects",
          },
        ];
  ...
  const mainContentData = {
    ...
    description:
      "Exclusive wellness villas for sale by Odiliya Residencies. ICON offers luxurious villas with full management services and high ROI potential of 30-40%. Limited units available, secure your piece of luxury living and smart investment today.",
    statistics: [
      {
        label: "30% - 40% ROI",
        highlight: true,
  ...
  const managementData = {
    ...
    description:
      "Operations and Marketing: Odiliya will handle all aspects of villa operations and marketing. This includes guest bookings, property management, housekeeping, and promotion of the villas to ensure high occupancy rates and maximum profitability.",
  };

  const profitSharingData = {
    title: "PROFIT MODEL - NET PROFIT SHARING",
    description:
      "After deducting all operational expenses, net profits will be shared between the company and villa owners as follows:",
    shares: [
  ...
  return (
    <>
      ...
      >
        <IconHeroSection
          mediaType="video"
          video="https://pub-9bd45192d22f4f0e895c52adcfb2460a.r2.dev/envato_video_gen_Jan_08_2026_6_04_57_1_zgk0zs.mp4"
          title="ODILIYA ICON"
